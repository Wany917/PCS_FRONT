//ce fichier n'a pas été modifier 
                ...
                <CardContent>
                  <Card sx={{ borderRadius: 1 }} variant="outlined">
                    <PropertyList divider={<Divider />} sx={{ '--PropertyItem-padding': '12px 24px' }}>
                      {(
                        [
                          { key: t('customer'), value: <Link variant="subtitle2">Miron Vitold</Link> },
                          {
                            key: t('address'),
                            value: (
                          ...
                          { key: t('date'), value: dayjs().subtract(3, 'hour').format('MMMM D, YYYY hh:mm A') },
                          {
                            key: t('status'),
                            value: (
                              <Chip
