...
function CustomerFilterPopover(): React.JSX.Element {
  ...
  return (
    <FilterPopover anchorEl={anchorEl} onClose={onClose} open={open} title={t('filterByCustomer')}>
      <FormControl>
        <OutlinedInput
          onChange={(event) => {
...
function IdFilterPopover(): React.JSX.Element {
  ...
  return (
    <FilterPopover anchorEl={anchorEl} onClose={onClose} open={open} title={t('filterById')}>
      <FormControl>
        <OutlinedInput
          onChange={(event) => {
            setValue(event.target.value);
