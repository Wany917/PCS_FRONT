...
import { Download as Download } from '@phosphor-icons/react/dist/ssr/Download';

const bars = [
  { name: 'Cette année', dataKey: 'v1', color: 'var(--mui-palette-primary-400)' },
  { name: 'Année précedente', dataKey: 'v2', color: 'var(--mui-palette-primary-600)' },
...
export function AppUsage({ data }: AppUsageProps): React.JSX.Element {
  ...
  return (
    <Card>
      <CardHeader title="App usage" icon={Download} />
      <CardContent>
          ...
          <Stack spacing={3} sx={{ flex: '0 0 auto', justifyContent: 'space-between', width: '240px' }}>
            <Stack spacing={2}>
              ...
              <Typography color="text.secondary">
                Augmentaion des utilisateurs de {' '}
                <Typography color="text.primary" component="span">
                  6,521
                </Typography>{' '}
                depuis la nouvelle version de l'application.
              </Typography>
            </Stack>
            <div>
              <Typography color="text.secondary" variant="body2">
                <Typography color="primary.main" component="span" variant="subtitle2">
                 ...
                 il y aura beaucoup plus de traffic sur le site. 
              </Typography>
            </div>
          </Stack>
