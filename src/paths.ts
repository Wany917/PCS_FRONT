export const paths = {
  ...
  dashboard: {
    ...
    prestation: '/dashboard/prestation',
    chat: {
      base: '/dashboard/chat',
    ...
    societies: {
      list: '/dashboard/societies',
      create: '/dashboard/societies/create',
      details: (societyId: string) => `/dashboard/societies/${societyId}`,
    },
    ...
    properties: {
      ...
      preview: (propertyId: string) => `/dashboard/properties?previewId=${propertyId}`,
      details: (propertyId: string) => `/dashboard/properties/${propertyId}`,
    },
    social: {
    ...
    facilities: {
      ...
      create: '/dashboard/facilities/create',
      details: (facilityId: string) => `/dashboard/facilities/${facilityId}`,
    },
  },
